...
export default async function Dashboard() {
  ...
  return (
    <div className="mb-3">
      <div className="mt-8 w-5/6 mx-auto flex flex-wrap md:flex-nowrap justify-center md:justify-between gap-5">
      ...
      <div className="lg:flex justify-between gap-2 mt-8">
