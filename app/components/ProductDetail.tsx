    ...
    <div className="py-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row ">
          ...
          <div className="py-2 md:flex-1 md:pl-3">
            <p className="text-2xl font-bold text-gray-800 mb-2">
              {product?.product_name}
            </p>
            <p className="text-xl font-bold text-gray-800 mb-2 ml-2">
            ...
            <div className="flex mb-4 flex-col ml-1 gap-4">
              <div className="flex items-start ml-2">
                ...
                <span className="font-bold text-gray-700">Descripción:  <span className="font-normal ml-1 text-gray-600">
                  {product?.description}
                </span></span>
            ...
            <div className="flex justify-center items-center w-full">
                <div className=" bg-[#1A72DD] flex justify-center rounded-xl items-center md:w-48">
