...
export default function CategoryCard({ category }: { category: Category }) {
    return (
        <div className="flex items-center justify-between bg-white rounded-lg shadow-md p-4 mb-3">
            ...
            <Link  href={`/gestion/products/detail/${category.id}`}><IoIosInformationCircleOutline color="blue" size={24}/></Link>
